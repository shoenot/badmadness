...
def main():
    ...
    print(BOLD + PURPLE + "\nSouth Region: \n" + END)
    south_bracket.print_bracket(key=lambda t: f" {t["seed"]} {t["name"]}")

    east_bracket = Bracket(east_region, pick_winner_by_seed)
    print(BOLD + PURPLE + "\nEast Region: \n" + END)
    east_bracket.print_bracket(key=lambda t: f" {t["seed"]} {t["name"]}")

    west_bracket = Bracket(west_region, pick_winner_by_seed)
    print(BOLD + PURPLE + "\nWest Region: \n" + END)
    west_bracket.print_bracket(key=lambda t: f" {t["seed"]} {t["name"]}")

    midwest_bracket = Bracket(midwest_region, pick_winner_by_seed)
    print(BOLD + PURPLE + "\nMidwest Region: \n" + END)
    midwest_bracket.print_bracket(key=lambda t: f" {t["seed"]} {t["name"]}")
